...
if ( ! function_exists( 'marcsolutions_setup' ) ) :
...
function marcsolutions_setup() {
	...
	load_theme_textdomain( 'marcsolutions', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'marcsolutions_custom_background_args', array(
