...
<?php $author_info = isset($_GET['author_name']) ? get_user_by('slug', $author_name) : get_userdata(intval($author)); ?>

<section class="image-page-header image-page-header_<?php echo strtolower(get_queried_object()->name); ?> container-fluid">

	<h1 class="image-page-header__title"><?php _e('Posted by'); ?> <?php echo $author_info->nickname; ?></h1>
