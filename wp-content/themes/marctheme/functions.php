<?php
/**
 * marctheme functions and definitions
 *
 ...
 */
function marctheme_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on marctheme, use a find and replace
	 * to change 'marctheme' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'marctheme', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'marctheme_setup' );
 ...
 */
function marctheme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'marctheme_content_width', 640 );
}
add_action( 'after_setup_theme', 'marctheme_content_width', 0 );
 ...
 */
function marctheme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'marctheme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'marctheme' ),
...
function marctheme_scripts() {
	...
	wp_enqueue_script( 'marctheme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'marctheme_scripts' );
