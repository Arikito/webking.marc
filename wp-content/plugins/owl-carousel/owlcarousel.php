...
class owl_Widget extends WP_Widget {
    ...
    public function form($instance) {
        ...
        if (isset($instance['singleitem'])) {
            $singleitem = $instance['singleitem'];
        } else {
            $singleitem = 'true';
        }
        ?>
        ...
        <p>
            <?php var_dump($singleitem);?>
            <label for="<?php echo $this->get_field_id('singleitem'); ?>"><?php _e('Single Item:'); ?></label>
            <select class="widefat" name="<?php echo $this->get_field_name('singleitem'); ?>" id="<?php echo $this->get_field_id('singleitem'); ?>">
                    <option value="true" <?php echo $singleitem == 'true'?'selected="selected"':null;?>><?php _e('Enabled') ?></option>
                    <option value="false" <?php echo $singleitem == 'false'?'selected="selected"':null;?>><?php _e('Disabled') ?></option>
            </select>
        </p>
        <?php
    }
    ...
    public function update($new_instance, $old_instance) {
        ...
        $instance['singleitem'] = strip_tags($new_instance['singleitem']);
    ...
    public function widget($args, $instance) {
        ...
        echo owl_function(array('category' => $instance['category'], 'singleItem' => $instance['singleitem'], 'autoPlay' => "true", 'pagination' => "false"));
        echo $after_widget;
    }
